...
$PANDAC -O -f js -o $JS_TARGET/ui src/ui/panda/panda/ui/*.panda src/ui/panda/panda/ui/events/*.panda src/ui/panda/panda/ui/images/*.panda src/ui/panda/panda/gl/*.panda
