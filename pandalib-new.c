...
#elif __APPLE__    
    os = class_panda$core$System$OperatingSystem$MACOSX;
#elif __linux
    os = class_panda$core$System$OperatingSystem$LINUX;
#else
    os = class_panda$core$System$OperatingSystem$OTHER_UNIX;
#endif
    panda$core$System$Type* type = class_panda$core$System$Type$NATIVE;
...
void panda$core$System$execStream_class_panda$core$String_panda$core$String_panda$core$$NativePointer_panda$core$$NativePointer_panda$core$$NativePointer_panda$collections$ListView(
        String* program, String* dir, void* inHandleArg, void* outHandleArg, 
        void* errHandleArg, 
        panda$collections$ListView* pandaArgs) {
    ...
    panda$collections$ListView$$ARR_Int64_$Rpanda$core$Object$Z_TYPE* subscript =
            pandaGetInterfaceMethod((panda$core$Object*) pandaArgs, 
                    &panda$collections$ListView_class, 
                    panda$collections$ListView$$ARR_Int64_$Rpanda$core$Object$Z_INDEX);
    int argCount = count((panda$collections$CollectionView$LTpanda$core$String$GT*) pandaArgs);
    char* args[argCount + 2];
    args[0] = path;
    int i;
    for (i = 0; i < argCount; i++)
        args[i + 1] = pandaGetString((String*) subscript(pandaArgs, i));
...
void panda$core$System$exec_class_panda$io$File_panda$io$File_panda$collections$ListView(
        panda$io$File* program, 
        panda$io$File* dir, 
        panda$collections$ListView* pandaArgs) {
    panda$core$System$execStream_class_panda$core$String_panda$core$String_panda$core$$NativePointer_panda$core$$NativePointer_panda$core$$NativePointer_panda$collections$ListView(program->path, dir->path, NULL, stdout, stderr,
                pandaArgs);
}
...
short panda$io$FileInputStream$read_class_panda$core$$NativePointer_$Rpanda$core$Int16(void* handle) {
    unsigned char b;
...
void panda$io$FileOutputStream$writeUInt8Array_class_panda$core$$NativePointer_panda$collections$ListView_Int64_Int64(
        void* handle, panda$collections$ListView* b, 
    ...
    while (length > 0) {
        ...
        for (int i = 0; i < currentLength; i++)
            data[i] = ((panda$core$UInt8Wrapper*) subscript(b, i + offset))->value;
        // FIXME check for errors
...
panda$collections$ListView* panda$io$File$list_$Rpanda$collections$ListView$LTpanda$io$File$GT(File* file) {
    ...
    if ((dir = opendir(path)) != NULL) {
        ...
        result = NULL;
    return (panda$collections$ListView*) result;
}
...
Bit panda$core$Panda$callBitFunction_class_panda$core$$NativePointer_$Rpanda$core$Bit(void* f) {
    return ((Bit (*)()) f)();
}

Int8 panda$core$Panda$callInt8Function_class_panda$core$$NativePointer_$Rpanda$core$Int8(void* f) {
    return ((Int8 (*)()) f)();
}

Int16 panda$core$Panda$callInt16Function_class_panda$core$$NativePointer_$Rpanda$core$Int16(void* f) {
    return ((Int16 (*)()) f)();
}

Int32 panda$core$Panda$callInt32Function_class_panda$core$$NativePointer_$Rpanda$core$Int32(void* f) {
    return ((Int32 (*)()) f)();
}
...
Char panda$core$Panda$callCharFunction_class_panda$core$$NativePointer_$Rpanda$core$Char(void* f) {
    return ((Char (*)()) f)();
}

Real32 panda$core$Panda$callReal32Function_class_panda$core$$NativePointer_$Rpanda$core$Real32(void* f) {
    return ((Real32 (*)()) f)();
}

Real64 panda$core$Panda$callReal64Function_class_panda$core$$NativePointer_$Rpanda$core$Real64(void* f) {
    return ((Real64 (*)()) f)();
}
...
void panda$threads$Thread$startThread_panda$collections$HashMap$LTpanda$core$Immutable$Cpanda$core$Object$GT(
        Thread* thread, 
...
Real32 panda$core$Panda$pow_class_Real32_Real32_$Rpanda$core$Real32(Real32 x, Real32 y) {
    return pow(x, y);
}

Real64 panda$core$Panda$pow_class_Real64_Real64_$Rpanda$core$Real64(Real64 x, Real64 y) {
    return pow(x, y);
}
...
void panda$core$Panda$debugWrite_class_Int64(Int v) {
    printf("Debug: %lld\n", v);
}
...
void panda$core$Panda$debugWrite_class_panda$core$Object(Object* o) {
