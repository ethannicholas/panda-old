...
typedef $LPpanda$core$Int64$Cpanda$core$Real64$RP*(panda$collections$Enumerator$LTpanda$core$Real64$GT$next_$R$LPpanda$core$Int64$Cpanda$core$Real64$RP_TYPE)(panda$collections$Enumerator$LTpanda$core$Real64$GT* self);
