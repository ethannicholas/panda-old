...
#ifndef panda$collections$PrimitiveArray$LTpanda$collections$ImmutableArray$LTpanda$parser$GLRParser$Action$Z$GT$GT_H
#define panda$collections$PrimitiveArray$LTpanda$collections$ImmutableArray$LTpanda$parser$GLRParser$Action$Z$GT$GT_H
extern panda$core$Class panda$collections$PrimitiveArray$LTpanda$collections$ImmutableArray$LTpanda$parser$GLRParser$Action$Z$GT$GT_class;
#ifndef CLASS_panda$collections$PrimitiveArray$LTpanda$collections$ImmutableArray$LTpanda$parser$GLRParser$Action$Z$GT$GT
