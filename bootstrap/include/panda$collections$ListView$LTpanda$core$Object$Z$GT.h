...
#ifndef panda$collections$ListView$LTpanda$core$Object$Z$GT_H
#define panda$collections$ListView$LTpanda$core$Object$Z$GT_H
extern panda$core$Class panda$collections$ListView$LTpanda$core$Object$Z$GT_class;
#ifndef CLASS_panda$collections$ListView$LTpanda$core$Object$Z$GT
#define CLASS_panda$collections$ListView$LTpanda$core$Object$Z$GT
struct panda$collections$ListView$LTpanda$core$Object$Z$GT {
    panda$core$Class* cl;
};

#define panda$collections$ListView$LTpanda$core$Object$Z$GT$get_iterator_$Rpanda$collections$Iterator$LTpanda$core$Object$Z$GT_INDEX 4
typedef panda$collections$Iterator$LTpanda$core$Object$Z$GT*(panda$collections$ListView$LTpanda$core$Object$Z$GT$get_iterator_$Rpanda$collections$Iterator$LTpanda$core$Object$Z$GT_TYPE)(panda$collections$ListView$LTpanda$core$Object$Z$GT* self);
#define panda$collections$ListView$LTpanda$core$Object$Z$GT$contains_panda$core$Object$Z_$Rpanda$core$Bit_INDEX 11
typedef Bit(panda$collections$ListView$LTpanda$core$Object$Z$GT$contains_panda$core$Object$Z_$Rpanda$core$Bit_TYPE)(panda$collections$ListView$LTpanda$core$Object$Z$GT* self, panda$core$Object*);
#define panda$collections$ListView$LTpanda$core$Object$Z$GT$convert_$Rpanda$collections$Array$LTpanda$core$Object$Z$GT_INDEX 12
typedef panda$collections$Array$LTpanda$core$Object$Z$GT*(panda$collections$ListView$LTpanda$core$Object$Z$GT$convert_$Rpanda$collections$Array$LTpanda$core$Object$Z$GT_TYPE)(panda$collections$ListView$LTpanda$core$Object$Z$GT* self);
#define panda$collections$ListView$LTpanda$core$Object$Z$GT$lastIndexOf_panda$core$Object$Z_$Rpanda$core$Int64Wrapper$Z_INDEX 13
typedef panda$core$Int64Wrapper*(panda$collections$ListView$LTpanda$core$Object$Z$GT$lastIndexOf_panda$core$Object$Z_$Rpanda$core$Int64Wrapper$Z_TYPE)(panda$collections$ListView$LTpanda$core$Object$Z$GT* self, panda$core$Object*);
#define panda$collections$ListView$LTpanda$core$Object$Z$GT$lastIndexOf_panda$core$Object$Z_Int64_$Rpanda$core$Int64Wrapper$Z_INDEX 14
typedef panda$core$Int64Wrapper*(panda$collections$ListView$LTpanda$core$Object$Z$GT$lastIndexOf_panda$core$Object$Z_Int64_$Rpanda$core$Int64Wrapper$Z_TYPE)(panda$collections$ListView$LTpanda$core$Object$Z$GT* self, panda$core$Object*, Int64);
#define panda$collections$ListView$LTpanda$core$Object$Z$GT$$SLE_panda$core$Int64Wrapper$Z_panda$core$Int64Wrapper$Z_Int64_$Rpanda$collections$ListView$LTpanda$core$Object$Z$GT_INDEX 15
typedef panda$collections$ListView$LTpanda$core$Object$Z$GT*(panda$collections$ListView$LTpanda$core$Object$Z$GT$$SLE_panda$core$Int64Wrapper$Z_panda$core$Int64Wrapper$Z_Int64_$Rpanda$collections$ListView$LTpanda$core$Object$Z$GT_TYPE)(panda$collections$ListView$LTpanda$core$Object$Z$GT* self, panda$core$Int64Wrapper*, panda$core$Int64Wrapper*, Int64);
#define panda$collections$ListView$LTpanda$core$Object$Z$GT$$SLE_Int64_Int64_Int64_$Rpanda$collections$ListView$LTpanda$core$Object$Z$GT_INDEX 16
