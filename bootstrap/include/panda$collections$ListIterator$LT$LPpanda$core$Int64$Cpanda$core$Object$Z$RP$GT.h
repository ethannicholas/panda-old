...
#ifndef panda$collections$ListIterator$LT$LPpanda$core$Int64$Cpanda$core$Object$Z$RP$GT_H
#define panda$collections$ListIterator$LT$LPpanda$core$Int64$Cpanda$core$Object$Z$RP$GT_H
extern panda$core$Class panda$collections$ListIterator$LT$LPpanda$core$Int64$Cpanda$core$Object$Z$RP$GT_class;
#ifndef CLASS_panda$collections$ListIterator$LT$LPpanda$core$Int64$Cpanda$core$Object$Z$RP$GT
#define CLASS_panda$collections$ListIterator$LT$LPpanda$core$Int64$Cpanda$core$Object$Z$RP$GT
struct panda$collections$ListIterator$LT$LPpanda$core$Int64$Cpanda$core$Object$Z$RP$GT {
    panda$core$Class* cl;
    panda$collections$ListView$LT$LPpanda$core$Int64$Cpanda$core$Object$Z$RP$GT* list;
    Int64 index;
};
