...
String* panda$core$Real32Wrapper$pandaReal32ToString_class_Real32_$Rpanda$core$String(Real32 r) {
...
Real32 panda$core$String$pandaStringToReal32_class_panda$core$String_$Rpanda$core$Real32(String* s) {
